...
export class EventCreationComponent implements OnInit {
  ...
  onEventDetailsSectionNextBtnClick() {
    ...
    let payload : any = {
      ...
      "startDate": this.eventsDataFormGroup.value.startDate == "" || this.eventsDataFormGroup.value.startDate == null ? null : this.formattedEventStartDate,
      //"endDate": this.eventsDataFormGroup.value.endDate == "" ? null : this.eventsDataFormGroup.value.endDate,
      "endDate": this.eventsDataFormGroup.value.endDate == "" || this.eventsDataFormGroup.value.endDate == null ? null : this.formattedEventEndDate,
      ...
      "registrationStartDate": this.eventsDataFormGroup.value.registrationStartDate == "" || this.eventsDataFormGroup.value.registrationStartDate == "1970-01-01" || this.eventsDataFormGroup.value.registrationStartDate == null ? null :  this.formattedEventRegisrtationStartDate,
      ...
      "registrationEndDate": this.eventsDataFormGroup.value.registrationEndDate == "" || this.eventsDataFormGroup.value.registrationEndDate == "1970-01-01" || this.eventsDataFormGroup.value.registrationEndDate == null ? null : this.formattedEventRegisrtationEndDate,
