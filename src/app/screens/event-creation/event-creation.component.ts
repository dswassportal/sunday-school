...
export class EventCreationComponent implements OnInit {
  ...
  onEventDetailsSectionNextBtnClick() {
    ...
    let payload : any = {
      ...
      "registrationStartDate": this.eventsDataFormGroup.value.registrationStartDate == "" || this.eventsDataFormGroup.value.registrationStartDate == null ? null :  this.formattedEventRegisrtationStartDate,
      ...
      "registrationEndDate": this.eventsDataFormGroup.value.registrationEndDate == "" || this.eventsDataFormGroup.value.registrationEndDate == null ? null : this.formattedEventRegisrtationEndDate,
