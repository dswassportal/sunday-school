...
const getAllRegisteredEventsAndScore = `select 
                                                distinct te.event_id, 
                                                case when tpeos.overall_score is null then tpes.score else tpeos.overall_score end as "overall_score", 
                                                tec."name" as category, tpeos.event_category_map_id ,te."name", te.event_type, 
