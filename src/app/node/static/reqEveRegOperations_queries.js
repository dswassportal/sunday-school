...
const getPrincipalwiseStudentsData = `select distinct  tosa2.user_id, tssd.student_id, tssd.school_grade,tosa.user_id as "teacher_user_id",
...
from t_student_sundayschool_dtl tssd
    ...
    join t_organization_staff_Assignment tosa on tosa.org_id = tssd.school_id 
            and tosa.is_deleted = false and tosa.is_primary = true
    join t_organization_staff_Assignment tosa2 on tosa2.org_id = torg.org_id	
            and tosa2.is_deleted = false and tosa2.is_primary = true
